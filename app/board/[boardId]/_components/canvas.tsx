...
const SELECTION_THRESHOLD = 5 // Magic Number - Companies
...
const Canvas = ({ boardId }: Props) => {
  ...
  }, [canvasState, resizeSelectedLayer, camera, translateSelectedLayer, continueDrawing, startMutiSelection, updateSelectionNet]);
    ...
    <div className='h-full w-full relative touch-none bg-neutral-100'>
        ...
        >
          ...
          >
            ...
            <SelectionBox
              onResizeHandlePointDown={onResizeHandlePointDown}
            />
